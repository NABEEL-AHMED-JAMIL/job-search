> **ARCHIVED — do not follow this document.** This is the `process/README.md` as it stood before
> 2026-09-01, kept as a record. It is superseded by `process/README.md`, and several of its
> instructions now fail: see [TRIAGE.md](TRIAGE.md) for what was checked and [README.md](README.md)
> for why the bootstrap SQL and actuator sections are worth preserving.
>
> Relative links below are broken here because the file has been copied out of `process/` — the
> images it references live at `process/ext-detail/`, and `DOCKER_SETUP.md` never existed at all.
